...
# The first entry, 0, is a placeholder. The first value, 31,
...
def main():
    ...
    while True:
        try:
            ...
            if datetime_object < startDate or datetime_object > endDate:
    ...
    print("=" * 67)
    # First Output
    print("Weather Information For: ", months[inputMonth], dayString(inputDay) + ",", inputYear, "(is a",
          dayOfWeek(inputYear, inputMonth, inputDay) + ").")

    # Second Output
    # convert input date into integer separately
    ...
    for _ in WEATHERDATA:
        if tempStartYear < 2018 and tempStartYear != inputYear:
            ...
            if inputMonth != 2:
                ...
                weatherInfoHigh = WEATHERDATA[row][highTempCol]
                weatherInfoLow = WEATHERDATA[row][lowTempCol]
                print(str(inputMonth) + "/" + str(inputDay) + "/" + str(tempStartYear), "High Temp:",
                      (str(weatherInfoHigh) + "F").rjust(3),
                      ("(" + compareData(selectedDateHighTemp, weatherInfoHigh) + ")").ljust(5),
                      "Low Temp:".rjust(18), (str(weatherInfoLow) + "F").rjust(3),
                      ("(" + compareData(selectedDateLowTemp, weatherInfoLow) + ")").ljust(5))
                tempStartYear += 1
    ...
    print()
    print("The average high temperature from 2010 - 2017 for all", str(inputMonth) + "/" + str(inputDay), "days:",
          str(math.floor(averageHighTemp)), "F")
    print("The average low temperature from 2010 - 2017 for all", str(inputMonth) + "/" + str(inputDay), "days:",
          str(math.floor(averageLowTemp)), "F")
    print("The highest temperature from 2010 - 2017 on", str(inputMonth) + "/" + str(inputDay), "is",
          max(highTempRecord), "F")
    print("The lowest temperature from 2010 - 2017 on", str(inputMonth) + "/" + str(inputDay), "is", min(lowTempRecord),
          "F")
    ...
    for _ in WEATHERDATA:
        # condition for not including input year info
        if humidityStartYear < 2018 and humidityStartYear != inputYear:
            if inputMonth != 2:
                humidityRow = findRowIndex(humidityStartYear, inputMonth, inputDay)
                humidityInfo = WEATHERDATA[humidityRow][aveHumCol]
                print(str(inputMonth) + "/" + str(inputDay) + "/" + str(humidityStartYear), "Average Humidity:",
                      str(humidityInfo).rjust(2), "%",
    ...
    print()
    print("The average humidity from 2010 - 2017 for all", str(inputMonth) + "/" + str(inputDay), "days:",
          str(math.floor(averageHumidity)) + "%")
    ...
    for _ in WEATHERDATA:
        ...
        if windStartYear < 2018 and windStartYear != inputYear:
            if inputMonth != 2:
                windRow = findRowIndex(windStartYear, inputMonth, inputDay)
                windInfo = WEATHERDATA[windRow][aveWindCol]
                print(str(inputMonth) + "/" + str(inputDay) + "/" + str(windStartYear), "Average Wind:",
                      str(windInfo).rjust(2), "MPH",
    ...
    print()
    print("The average wind from 2010 - 2017 for all", str(inputMonth) + "/" + str(inputDay), "days:",
          str(math.floor(averageWind)) + "MPH")
...
def seasonInfo(year, month, day):
    ...
    if springStart <= date2 <= springEnd:
    ...
    elif summerStart <= date2 <= summerEnd:
    ...
    elif autumnStart <= date2 <= autumnEnd:
    ...
    elif winterStart <= date2 <= endOfYear:
    ...
    elif startOfYear <= date2 <= winterEnd:
...
# Returns a formatted string in the format: 1st, 2nd, 3rd, 4th, etc.
def dayString(day):
